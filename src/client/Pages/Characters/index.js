import { Avatar, Backdrop, Button, Chip, CircularProgress, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, FormLabel, Input, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField } from '@material-ui/core';
  ...
  return ( 
    ...
    {/* BODY CONTAINER */}
        ...
        />
          ...
          <Input style={{marginLeft: "50px"}} placeholder="Search"/>
          </div>
    ...
    {/* BODY CONTAINER */}
        ...
        <Dialog open={toggle.add} onClose={() => handleClose('add')} aria-labelledby="form-dialog-title">
          ...
          <DialogContent>
            ...
            <FormLabel>Image Avatar - <input type="file" onChange={handleAdd("avatar")}/></FormLabel><br /><br/>
            <FormLabel>Image Portrait - <input type="file" onChange={handleAdd("portrait")}/></FormLabel><br /><br />
            <FormLabel>Image Landscape - <input type="file" onChange={handleAdd("landscape")}/></FormLabel>
          </DialogContent>
          <DialogActions>
        ...
        <Dialog open={toggle.delete} onClose={() => handleClose('delete')} aria-labelledby="form-dialog-title">
          ...
          <DialogActions>
            ...
            <Button onClick={DeleteCharacter} disabled={loading} color="primary">
              {loading ? "Please Wait" : "Add"}
            </Button>
